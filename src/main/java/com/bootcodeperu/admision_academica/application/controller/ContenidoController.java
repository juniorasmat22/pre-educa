...
public class ContenidoController {
    ...
    public ResponseEntity<List<ContenidoTeoria>> getTeoriaByTema(@PathVariable Long temaId) {
        List<ContenidoTeoria> teoria = contenidoService.getContenidoTeoriaByTemaId(temaId);

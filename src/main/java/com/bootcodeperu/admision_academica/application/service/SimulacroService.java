...
public interface SimulacroService {
     ...
     */
    List<PreguntaDetalleResponse> generarExamenSimulacro(Long usuarioId, Long areaId);
    ...
    void guardarProgreso(Long usuarioId, Map<String, String> respuestasParciales);
}
